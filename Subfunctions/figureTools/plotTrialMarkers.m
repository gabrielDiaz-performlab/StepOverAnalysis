...
%% Plot Rigid data
plotRigidData(trialData.rFoot.rbPos_mFr_xyz,'r');
plotRigidData(trialData.lFoot.rbPos_mFr_xyz,'b');
plotRigidData(trialData.glasses.rbPos_mFr_xyz,'k');
plotRigidData(trialData.spine.rbPos_mFr_xyz,'g');
